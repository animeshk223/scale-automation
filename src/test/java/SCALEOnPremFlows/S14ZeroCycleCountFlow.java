...
public class S14ZeroCycleCountFlow {
    ...
    static String sheetName = "S14- Zero Cycle Count";
    static int rowToStartFrom = 1;
    public static WebDriver driver;

    @DataProvider(name = "S14- Zero Cycle Count")
    ...
    @Test(dataProvider = "S14- Zero Cycle Count")
...
//Launch app
        if (runMode.equalsIgnoreCase("Y")) {
            Reports.startTest(Warehouse + " S14 Zero Cycle count when input quantity is - " + scenario, "Test Environment - " + appMode);
