...
public class S02ZeroCycleCountFlow {
    ...
    static String sheetName = "S02- Zero Cycle Count";
    static int rowToStartFrom = 1;
    public static WebDriver driver;

    @DataProvider(name = "S02- Zero Cycle Count")
    ...
    @Test(dataProvider = "S02- Zero Cycle Count")
...
//Launch app
        if (runMode.equalsIgnoreCase("Y")) {
            Reports.startTest(Warehouse + " S02 Zero Cycle count when input quantity is - " + scenario, "Test Environment - " + appMode);
