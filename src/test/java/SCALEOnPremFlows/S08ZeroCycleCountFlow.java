...
public class S08ZeroCycleCountFlow {
    ...
    static String sheetName = "S08- Zero Cycle Count";
    static int rowToStartFrom = 1;
    public static WebDriver driver;

    @DataProvider(name = "S08- Zero Cycle Count")
    ...
    @Test(dataProvider = "S08- Zero Cycle Count")
...
//Launch app
        if (runMode.equalsIgnoreCase("Y")) {
            Reports.startTest(Warehouse + " S08 Zero Cycle count when input quantity is - " + scenario, "Test Environment - " + appMode);
