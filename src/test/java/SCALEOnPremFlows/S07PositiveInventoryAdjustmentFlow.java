...
public class S07PositiveInventoryAdjustmentFlow {
    ...
    static String sheetName = "S07 Inv Adjustment positive";
    ...
    public static void invAdjustment(String SN, String scenario, String appMode, String runMode, String type, String item, String loc,
                                     String qty, String uDef2, String warehouse, String status)
            throws Exception {
