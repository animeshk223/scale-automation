...
public class S09ZeroCycleCountFlow {
    ...
    static String sheetName = "S09- Zero Cycle Count";
    static int rowToStartFrom = 1;
    public static WebDriver driver;

    @DataProvider(name = "S09- Zero Cycle Count")
    ...
    @Test(dataProvider = "S09- Zero Cycle Count")
...
//Launch app
        if (runMode.equalsIgnoreCase("Y")) {
            Reports.startTest(Warehouse + " S09 Zero Cycle count when input quantity is - " + scenario, "Test Environment - " + appMode);
