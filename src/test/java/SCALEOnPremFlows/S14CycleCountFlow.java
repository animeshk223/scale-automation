...
public class S14CycleCountFlow {
    ...
    static String sheetName = "S14- Cycle Count";
    static int rowToStartFrom = 1;
    public static WebDriver driver;


    @DataProvider(name = "S14 Cycle Count")
    ...
    @Test(dataProvider = "S14 Cycle Count")
    public static void CycleCount(String SN, String scenario, String appMode, String runMode,String item, String loc,String licensePlate,String AVQtyBeforeCC, String OHQtyBeforeCC, String SUQtyBeforeCC,String QtyInserted, String ExpectedAVQtyAfterCC,String ExpectedOHQtyAfterCC,String ExpectedSUQtyAfterCC,String Warehouse,String Company,String Status)
            throws Exception {
        String ReferenceID;
        String WorkUnit;
        ...
        if (runMode.equalsIgnoreCase("Y")) {
            ...
            PgCycleCountPlanInsight.waitForDisappearanceOfToastMsg();
            PgHome.clickOnHamburgerIcon();
