...
public class S15ZeroCycleCountFlow {
    ...
    static String sheetName = "S15- Zero Cycle Count";
    static int rowToStartFrom = 1;
    public static WebDriver driver;

    @DataProvider(name = "S15- Zero Cycle Count")
    ...
    @Test(dataProvider = "S15- Zero Cycle Count")
...
//Launch app
        if (runMode.equalsIgnoreCase("Y")) {
            Reports.startTest(Warehouse + " S15 Zero Cycle count when input quantity is - " + scenario, "Test Environment - " + appMode);
