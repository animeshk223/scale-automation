...
public class PositiveInventoryAdjustmentFlow {
    ...
    static String sheetName = "IHS - Inv Adjustment positive";
    ...
    public static void invAdjustment(String SN, String scenario, String appMode, String runMode, String type, String item, String loc,
                                     String licensePlate,String qty, String SerialNumber,String uDef2, String warehouse, String AVQtyBeforeAdjust,String OHQtyBeforeAdjust, String SUQtyBeforeAdjust,String ExpectedAVQtyAfterAdjust,String ExpectedOHQtyAfterAdjust,String ExpectedSUQtyAfterAdjust, String status)
            throws Exception {
        if (runMode.equalsIgnoreCase("Y")) {
            ...
            if (appMode.equalsIgnoreCase("Desktop")) {
                ...
                //Below code is specific to serialized item..
                if (!SerialNumber.equals("NA")) {
                    PgInventoryAdjustment.verifySerialNumberPlacerScreenIsDisplayed();
                    PgInventoryAdjustment.enterSerialNumberforPositiveAdjustment(SerialNumber);
                    PgInventoryAdjustment.clickOnSaveOfSerialPlacer();
                }
                //Serialized item specific code ends here..
                ...
                //Below code is specific to serialized item..
                if (!SerialNumber.equals("NA")) {
                    if (scenario.startsWith("Positive Adjustment")) {
                        PgSerialNumEntryRF.enterSerialNumber(SerialNumber);
                    }
                }
                //Serialized item specific code ends here..
